...
<Steps>
1. Enable the Webapp for your recordings: `/webapp on`

2. Start a recording with `/join`

3. Share the Webapp link (from the direct message with your recording info) with participants

4. Participants open the link in a browser and enter a name to connect as
